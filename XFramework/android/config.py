...
def huawei_init(uiObj):
    ...
    while numCount > 0:
        ...
        uiObj._LOGGER.warning(u'huawei: 点击初始化app弹窗失败，请检测app控件名是否正确！')
...
def vivo_init(uiObj):
    ...
    while numCount > 0:
        ...
        uiObj._LOGGER.warning(u'vivo: 点击初始化app弹窗失败，请检测app控件名是否正确！')
...
def oppo_init(uiObj):
    ...
    while numCount > 0:
        ...
        uiObj._LOGGER.warning(u'oppo: 点击初始化app弹窗失败，请检测app控件名是否正确！')
